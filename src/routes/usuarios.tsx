          ...
          <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-md">
              <DialogHeader>
                ...
                <DialogDescription>Defina nome, e-mail e papel de acesso.</DialogDescription>
              </DialogHeader>
              <div className="space-y-3 py-2">
                <div className="space-y-1.5">
                  <Label>Nome</Label>
                  <Input id="uname" placeholder="Nome completo" />
                </div>
                <div className="space-y-1.5">
                  <Label>E-mail</Label>
                  <Input id="uemail" type="email" placeholder="nome@empresa.com" />
                </div>
                <div className="space-y-1.5">
                  <Label>Senha</Label>
                  <Input id="upass" type="password" placeholder="Mínimo 6 caracteres" />
                </div>
                <div className="space-y-1.5">
                  <Label>Role</Label>
                  <select
